...
namespace OneSync
{
    ...
    {
        private const string MenuName = "Folder\\shell\\OneSyncMenuOption-v3.0";
        private const string Command = "Folder\\shell\\OneSyncMenuOption-v3.0\\command";

        private const string AppMenuName = "Folder\\shell\\OneSyncMenuOption-v3.0App";
        private const string AppCommand = "Folder\\shell\\OneSyncMenuOption-v3.0App\\command";
        ...
        public override void Install(System.Collections.IDictionary stateSaver)
        {
            ...
            try
            {
                ...
                if(regmenu != null)
                    regmenu.SetValue("", "Sync with OneSync 3");
                ...
                if (regmenu != null)
                    regmenu.SetValue("", "Open OneSync 3");
