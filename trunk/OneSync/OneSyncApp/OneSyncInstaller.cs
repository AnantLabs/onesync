...
namespace OneSync
{
    ...
    {
        private const string MenuName = "Folder\\shell\\OneSyncMenuOption-v4.0";
        private const string Command = "Folder\\shell\\OneSyncMenuOption-v4.0\\command";

        private const string AppMenuName = "Folder\\shell\\OneSyncMenuOption-v4.0App";
        private const string AppCommand = "Folder\\shell\\OneSyncMenuOption-v4.0App\\command";
